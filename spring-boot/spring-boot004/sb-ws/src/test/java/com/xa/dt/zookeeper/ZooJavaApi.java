...
public class ZooJavaApi {
    ...
    public static void main(String[] args) {
        try {
            ...
            ZooKeeper zooKeeper = new ZooKeeper(HOST, SESSION_TIMEOUT, watcher);
            try {
    ...
    public void testCreate() {
        ...
        String result = null;
        try {
            result = zookeeper.create(createNode, createNodeData.getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
        } catch (Exception e) {
            logger.error("", e);
            Assert.fail();
        }
